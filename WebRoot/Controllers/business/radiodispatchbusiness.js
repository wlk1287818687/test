...
xh.load = function() {
	...
	app.controller("radiodispatchbusiness", function($scope, $http) {
		xh.maskShow();
		...
		$scope.search = function(page) {
			...
			xh.maskShow();
			$http.get(
					"../../radiodispatchbusiness/list?id=" + id + "&name=" + name + "&start="
...
// 刷新数据
xh.refresh = function() {
	var appElement = document.querySelector('[ng-controller=radiodispatchbusiness]');
