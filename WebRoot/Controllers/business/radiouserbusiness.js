...
xh.load = function() {
	...
	app.controller("radiouserbusiness", function($scope, $http) {
		xh.maskShow();
		$scope.count = "20";// 每页数据显示默认值
		$scope.systemMenu = true; // 菜单变色
		$http.get(
				"../../radiouserbusiness/list?id=" + id + "&name=" + name
...
// 刷新数据
xh.refresh = function() {
	var appElement = document.querySelector('[ng-controller=radiouserbusiness]');
